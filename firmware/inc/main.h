...
#define MOT1_IN1_GPIO_Port GPIOC
#define MOT1_IN2_Pin GPIO_PIN_1
#define MOT1_IN2_GPIO_Port GPIOC
#define MOT3_IN2_Pin GPIO_PIN_2
#define MOT3_IN2_GPIO_Port GPIOC
...
#define MOT2_nFAULT_EXTI_IRQn EXTI9_5_IRQn
...
#define MOT3_EN_Pin GPIO_PIN_5
#define MOT3_EN_GPIO_Port GPIOC
